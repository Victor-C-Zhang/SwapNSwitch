...
import com.example.numbergame.NumberGoalFragment;
import com.example.numbergame.NumberActivity;
import com.example.numbergame.R;


public class CustomTextNumberView extends android.support.v7.widget.AppCompatTextView {
    private Context context;
    private NumberGoalFragment goalFrag;
    public CustomTextNumberView(Context context) {
        super(context);
        this.context = context;
    }

    public CustomTextNumberView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public void setGoal(NumberGoalFragment goalFrag){
